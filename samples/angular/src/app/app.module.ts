...
} from "../chat-sdk/message-list/message-list.component"
...
import { ChannelsRelevantToUserComponent } from "../chat-sdk/channels-relevant-to-user/channels-relevant-to-user.component"
...
@NgModule({
  declarations: [
    ...
    ChannelsRelevantToUserComponent,
  ],
