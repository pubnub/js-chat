...
describe("Channel test", () => {
  ...
  test.skip("should fail when trying to create a channel without required parameters", async () => {
    jest.retryTimes(3)
  ...
  test.skip("should fail when trying to send a message to a non-existent channel", async () => {
    jest.retryTimes(3)
